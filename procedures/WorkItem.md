...
A compliant work item file begins with a `---`-delimited block containing three fields, followed by the document body:
...
When using `workflow-work-item-create`, the MCP tool writes this format automatically. Manual creation must follow this spec.
